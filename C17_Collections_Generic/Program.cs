...
namespace C17_Collections_Generic
{
    internal class Program
    {
        ...
        {
            // Khai báo một List kiểu dữ liệu string
            ...
            // Lấy phần tử từ List
            string fruit = stringList[0];
            Console.WriteLine(fruit);

            // Khai báo một Dictionary kiểu dữ liệu int, string
