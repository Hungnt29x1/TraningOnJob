...
namespace C13_LINQ
{
     class Program
    {
        ...
        private static List<Employees> _lstNhanViens;
        private static List<Category> _lstTheLoais;
        private static List<Products> _lsSanPhams;
        public Program()
        {
        ...
        static void LINQ_GROUPBY()
        {
            ...
            var lstColorLambda = _lsSanPhams.GroupBy(c => new { c.MauSac }).Select(g => new Products()
        ...
        static void LINQ_ALL_ANY()
        {
            ...
            Employees nv1 = new Employees()
            {
                Id = 1,
                MaNV = "Dungna29",
                TenNV = "Dũng",
                Email = "dungna219@gmail.com",
                Sdt = "0912345678",
                DiaChi = null,
                ThanhPho = "HN",
                QueQuan = "HN",
            ...
            //var temp3 = _lstNhanViens.Contains(nv1, new Employees());//So sánh 1 đối tượng có các thuộc tính tương đồng.
        ...
        static void LINQ_CONCAT()
        {
            ...
            List<Products> lstSP1 = new List<Products>
            {
                new Products
                {
        ...
        static void LINQ_Distinct()
        {
            ...
            //foreach (var x in _lstNhanViens.Distinct(new Employees()))
            //{
            //    x.InRaManHinh();
            //}
